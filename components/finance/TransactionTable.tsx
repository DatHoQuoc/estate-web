...
export function TransactionTable({ records, onRowClick }: TransactionTableProps) {
          ...
          {records.map((r) => {
            ...
            return (
              ...
              >
                ...
                <TableCell className={cn("text-right font-mono text-sm", r.gatewayAmount === null ? "text-muted-foreground" : r.gatewayAmount < 0 ? "text-destructive" : "text-card-foreground")}>
